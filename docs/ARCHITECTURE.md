...
Этот документ описывает внутреннюю архитектуру **GLRX** — модульного
GNSS-приёмника на Rust.

Цели архитектуры:

- воспроизводимый DSP-конвейер;
- модульные, тестируемые компоненты обработки сигналов;
- чёткое разделение сигнал-обработки и навигационной логики;
- удобство экспериментов с алгоритмами GNSS;
- интеграция с внешней телеметрией и инструментами анализа.

---

## 1. Обзор системы

GLRX организован как однонаправленный **конвейер обработки сигналов**.
Он преобразует необработанные IQ-сэмплы в навигационные решения и телеметрию.

Основные этапы конвейера (логический поток данных):
